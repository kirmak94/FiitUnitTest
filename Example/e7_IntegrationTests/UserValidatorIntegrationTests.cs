...
public class UserValidatorIntegrationTests
{
    ...
    {
        var userValidator = new UserValidator(new NameValidator(), new PasswordValidator(), new EmailValidator());
        var user = new User("Ivan", "123456@Qwerty", "asdfdad@dfasdas.asd");
    ...
    {
        var user = new User("Ivan", string.Empty, "asdfdad@dfasdas.asd");
    ...
    {
        yield return
            new TestCaseData(new User(InvalidName, ValidPassword, ValidEmail), "InvalidName")
                .SetName("name not valid");
        yield return
            new TestCaseData(new User(ValidName, ValidPassword, InvalidEmail), "InvalidEmail")
                .SetName("email not valid");
        yield return
            new TestCaseData(new User(ValidName, InvalidPassword, ValidEmail), "InvalidPassword")
